// GxEPD_HD_DESTM32L_Example : test example for HD e-Paper displays from Dalian Good Display Inc. (parallel interface).
//
...
//#include "GxDESTM32L/GxGDE043A2/GxGDE043A2.h"
#include "GxDESTM32L/GxGDE060BA/GxGDE060BA.h"
//#include "GxDESTM32L/GxGDEW080T5/GxGDEW080T5.h"
...
#include "GxDESTM32L/GxIO_DESTM32L/GxIO_DESTM32L.h"
...
void showBitmapExample()
{
  ...
  delay(5000);
  display.fillScreen(GxEPD_WHITE);
  display.drawBitmap(bwBitmap640x384_2, (GxEPD_WIDTH - 640) / 2, (GxEPD_HEIGHT - 384) / 2, 640, 384, GxEPD_BLACK, GxEPD_HD::bm_flip_y);
  display.update();
  delay(10000);
#endif
}
