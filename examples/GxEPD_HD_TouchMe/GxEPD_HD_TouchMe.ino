...
void showTouchMe(uint16_t x, uint16_t y, uint16_t r)
{
  ...
  // getTextBounds doesn't work anymore.
  //  int16_t tbx, tby; uint16_t tbw, tbh;
  //  display.getTextBounds(TouchMe, 0, 0, &tbx, &tby, &tbw, &tbh);
  //  DiagnosticStream.print(tbx); DiagnosticStream.print(" "); DiagnosticStream.print(tby); DiagnosticStream.print(" "); DiagnosticStream.print(tbw); DiagnosticStream.print(" "); DiagnosticStream.println(tbh);
