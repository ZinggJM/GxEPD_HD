// Class AVT6203A : display IO component class for GDE06BA on my DESP32T (proto board) for TCon-11 parallel interface e-paper display from Dalian Good Display Inc.
//
...
void AVT6203A::avt_busy_wait(void)
{
  while (1)
  {
    if (AVT_RDY != 0)
...
uint16_t AVT6203A::avt_i80_read_dat(void)
{
  uint16_t value;
  AVT_HCS_L;
  avt_busy_wait();
  pinio16.portMode16(INPUT);
  AVT_HDC_H;
  AVT_HRD_L;
  value = pinio16.read16();
  AVT_HRD_H;
  pinio16.portMode16(OUTPUT);
  AVT_HCS_H;
  return value;
}

void AVT6203A::avt_i80_write_dat(uint16_t dat)
{
  AVT_HCS_L;
  pinio16.write16(dat);
  AVT_HWE_L;
...
void AVT6203A::avt_i80_write_cmd(uint16_t cmd)
{
  AVT_HCS_L;
  avt_busy_wait();
  pinio16.write16(cmd);
...
void AVT6203A::avt_init_cmd_set(uint16_t SPI_CFG, uint32_t SFM)
{
...
void AVT6203A::avt_init_pll_stby(uint16_t PLL_CFG0, uint16_t PLL_CFG1, uint16_t PLL_CFG2)
{
...
void AVT6203A::avt_run_sys(void)
{
...
void AVT6203A::avt_stby(void)
{
  avt_i80_write_cmd(0x0004);
  avt_busy_wait();
}

void AVT6203A::avt_slp(void)
{
...
void AVT6203A::avt_init_sys_run(void)
{
...
void AVT6203A::avt_init_sys_stby(void)
{
  avt_i80_write_cmd(0x0007);
}

void AVT6203A::avt_init_sdram(uint16_t SDRAM_CFG0, uint16_t SDRAM_CFG1, uint16_t SDRAM_CFG2, uint16_t SDRAM_CFG3)
{
...
void AVT6203A::avt_init_dspe_cfg(uint16_t HSIZE, uint16_t VSIZE, uint16_t SDRVCFG, uint16_t GDRVCFG, uint16_t IDX_FMT_CFG)
{
...
void AVT6203A::avt_init_dspe_tmg(uint16_t FSYNC_CFG, uint16_t F_BEGIN_END, uint16_t LSYNC_CFG, uint16_t L_BEGIN_END, uint16_t PIXEL_CLK_CFG)
{
...
void AVT6203A::avt_init_rotmode(uint16_t ROTMODE)
{
...
uint16_t AVT6203A::avt_rd_reg(uint16_t REG_ADDR)
{
  uint16_t REG_DATA;
...
void AVT6203A::avt_wr_reg(uint16_t REG_ADDR, uint16_t REG_DATA)
{
...
void AVT6203A::avt_wr_reg_addr(uint16_t REG_ADDR)
{
  avt_i80_write_cmd(0x0011);
  avt_i80_write_dat(REG_ADDR); 	//REG_ADDR[15:0]
}

void AVT6203A::avt_rd_sfm(void)
{
  avt_i80_write_cmd(0x0012);
}

void AVT6203A::avt_wr_sfm(uint16_t SFM_DATA)
{
  avt_i80_write_cmd(0x0013);
  avt_i80_write_dat(SFM_DATA); 	//SFM_DATA[15:0]
}

void AVT6203A::avt_end_sfm(void)
{
...
void AVT6203A::avt_bst_rd_sdr(uint16_t MA0, uint16_t MA1, uint16_t BC0, uint16_t BC1)
{
...
void AVT6203A::avt_bst_wr_sdr(uint16_t MA0, uint16_t MA1, uint16_t BC0, uint16_t BC1)
{
...
void AVT6203A::avt_bst_end_sdr(void)
{
...
void AVT6203A::avt_ld_img(uint16_t ARG)
{
  avt_i80_write_cmd(0x0020);
  avt_i80_write_dat(ARG); 			//REG_0140[5:4]
}

void AVT6203A::avt_ld_img_area(uint16_t ARG, uint16_t XSTART, uint16_t YSTART, uint16_t WIDTH, uint16_t HEIGHT)
{
...
void AVT6203A::avt_ld_img_end(void)
{
  avt_i80_write_cmd(0x0023);
}

void AVT6203A::avt_ld_img_wait(void)
{
  avt_i80_write_cmd(0x0024);
}

void AVT6203A::avt_ld_img_setadr(uint32_t MA)
{
...
void AVT6203A::avt_ld_img_dspeadr(void)
{
...
void AVT6203A::avt_wait_dspe_trg(void)
{
  avt_i80_write_cmd(0x0028);
}

void AVT6203A::avt_wait_dspe_frend(void)
{
...
void AVT6203A::avt_wait_dspe_lutfree(void)
{
  avt_i80_write_cmd(0x002A);
  avt_busy_wait();
}

void AVT6203A::avt_wait_dspe_mlutfree(uint16_t LUTMASK)
{
...
void AVT6203A::avt_rd_wfm_info(uint32_t MA)
{
...
void AVT6203A::avt_upd_init(void)
{
  avt_i80_write_cmd(0x0032);
}

void AVT6203A::avt_upd_full(uint16_t ARG)
{
  avt_i80_write_cmd(0x0033);
  avt_i80_write_dat(ARG);     		//REG_0334[14][11:4]
}

void AVT6203A::avt_upd_full_area(uint16_t ARG, uint16_t XSTART, uint16_t YSTART, uint16_t WIDTH, uint16_t HEIGHT)
{
...
void AVT6203A::avt_upd_part(uint16_t ARG)
{
  avt_i80_write_cmd(0x0035);
  avt_i80_write_dat(ARG);     		//REG_0334[14][11:4]
}

void AVT6203A::avt_upd_part_area(uint16_t ARG, uint16_t XSTART, uint16_t YSTART, uint16_t WIDTH, uint16_t HEIGHT)
{
...
void AVT6203A::avt_upd_gdrv_clr(void)
{
  avt_i80_write_cmd(0x0037);
}

void AVT6203A::avt_upd_set_imgadr(uint32_t ADR)
{
...
void AVT6203A::avt_check_soft_ready(void)
{
...
void AVT6203A::avt_spi_flash_idle_wait(void)
{
  uint16_t regval;
...
void AVT6203A::avt_spi_flash_write_byte(uint8_t dat)
{
  uint16_t v;
...
uint8_t AVT6203A::avt_spi_flash_read_byte(void)
{
  uint16_t v;
...
uint8_t AVT6203A::avt_spi_flash_read_status(void)
{
  uint8_t status;
...
void AVT6203A::avt_spi_flash_deal_wait(void)
{
  while (1)
  {
...
void AVT6203A::avt_spi_flash_write_enable(void)
{
  avt_wr_reg(0x0208, 0x1);
...
void AVT6203A::avt_spi_flash_write_disable(void)
{
  avt_wr_reg(0x0208, 0x1);
...
void AVT6203A::avt_spi_flash_earase()
{
...
void AVT6203A::avt_spi_flash_sector_earase(uint32_t addr)			//4K earase
{
...
void AVT6203A::avt_spi_flash_write_page(uint32_t addr, uint8_t *data)	//256bytes write
{
  uint16_t i;
  uint8_t addr1, addr2, addr3;
...
void AVT6203A::avt_spi_flash_write_buff(uint32_t addr, uint32_t len, uint8_t *buff)
{
  uint32_t i, pagenum;
  uint8_t *buffptr;
...
void AVT6203A::avt_spi_flash_read_buff(uint32_t addr, uint32_t len, uint8_t *buff)
{
  uint32_t i;
  uint8_t addr1, addr2, addr3;
...
void AVT6203A::avt_spi_flash_read_id(void)
{
  uint8_t temp1, temp2;
...
void AVT6203A::avt_spi_flash_write_waveform_deal(void)
{
...
void AVT6203A::avt_spi_flash_write_waveform_start(void)
{
...
void AVT6203A::avt_spi_flash_write_waveform_end(void)
{
  avt_wr_reg(0x0204, Reg0x0204Save);
}

void AVT6203A::avt_waveform_update(void)
{
...
void AVT6203A::AVT_CONFIG_check(void)
{
...
void AVT6203A::startTransfer()
{
  pinio16.startTransfer();
}

void AVT6203A::transfer16(uint16_t value)
{
  AVT_HCS_L;
  pinio16.transfer16(value);
  AVT_HWE_L;
  AVT_HWE_H;
  AVT_HCS_H;
}

void AVT6203A::endTransfer()
{
  pinio16.endTransfer();
}
...
void AVT6203A::Debug_dec(unsigned int dat)
{
  char buf[7];
