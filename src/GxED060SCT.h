...
#ifndef _GxED060SCT_H_
#define _GxED060SCT_H_

#include "GxEPD_HD_EPD.h"

class GxED060SCT : public GxEPD_HD_EPD
{
  public:
    // attributes
    static const uint16_t WIDTH = 800;
    static const uint16_t HEIGHT = 600;
    static const GxEPD_HD::Panel panel = GxEPD_HD::ED060SCT;
    static const bool hasColor = false;
    static const bool hasPartialUpdate = true;
    static const bool hasFastPartialUpdate = true;
    // constructor
    GxED060SCT(GxEPD_HD_IOCTRL& io, uint16_t vcom_mV = 2000); // abs(vcom*1000)
    GxED060SCT(GxEPD_HD_IOCTRL& io, double vcom);
    // methods (virtual)
