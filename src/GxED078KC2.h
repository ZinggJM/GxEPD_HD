...
#ifndef _GxED078KC2_H_
#define _GxED078KC2_H_

#include "GxEPD_HD_EPD.h"

class GxED078KC2 : public GxEPD_HD_EPD
{
  public:
    // attributes
    static const uint16_t WIDTH = 1872;
    static const uint16_t HEIGHT = 1404;
    static const GxEPD_HD::Panel panel = GxEPD_HD::ED078KC2;
    static const bool hasColor = false;
    static const bool hasPartialUpdate = true;
    static const bool hasFastPartialUpdate = true;
    // constructor
    GxED078KC2(GxEPD_HD_IOCTRL& io, uint16_t vcom_mV = 2000); // abs(vcom*1000)
    GxED078KC2(GxEPD_HD_IOCTRL& io, double vcom);
    // methods (virtual)
